...
int main()
{
	...
	printf("\nEnter your math subject marks:");//Math = 72 marks
	scanf("%d",&maths);
	
	printf("\nEnter your physics subject marks:");//phy = 65 marks
	scanf("%d",&phy);
	
	printf("\nEnter your chemistry subject marks:");//chem = 51 marks
	scanf("%d",&chem);
	
	total = maths + phy + chem ; //total = 188 marks 
	
	printf("\nTotal of 3 subject is = %d", total);
	
	sumofmathNphy = maths + phy ;//sumofmathNphy = 137 marks
